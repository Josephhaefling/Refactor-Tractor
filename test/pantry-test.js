...
describe('Pantry', function () {
  ...
  it('should be able to check pantry ingredients', function () {
    const ingredients = recipe.ingredients[0]
    expect(pantry.checkPantryForIngredients(ingredients)).to.deep.equal(false);
  });
  
  it('should be able to check pantry ingredients', function () {
    const ingredients = recipe.ingredients[3]
    expect(pantry.checkPantryForIngredients(ingredients)).to.deep.equal({
      "name": "rat poison",
      "id": 4,
      "quantity": {
        "amount": 0.5,
